...
<head lang="ru">
    ...
    <link rel="stylesheet"
          type="text/css"
          href="/css/main.css?v=5638b5a">

    <?php
    if ($isCreatorView ?? null) { ?>
        <script src="/js/functions.js?v=6e0b0c0"></script>
        <?php
    ...
    <script src="/js/main.js?v=bb6be6b"></script>
    <script src="/js/i18n/<?= $this->Config->getLang() ?>.js?7"></script>
