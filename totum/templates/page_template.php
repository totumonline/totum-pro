...
<head lang="ru">
    ...
    <link rel="stylesheet"
          type="text/css"
          href="/css/main.css?v=49297ca">

    <?php
    if ($isCreatorView ?? null) { ?>
        <script src="/js/functions.js?v=ce03db9"></script>
        <?php
    ...
    <script src="/js/main.js?v=9824570"></script>
    <script src="/js/i18n/<?= $this->Config->getLang() ?>.js?27"></script>
